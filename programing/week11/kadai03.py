...
class Matrix:
    def __init__(self, m11, m12 = 0, m21 = 0, m22 = ""):
        if isinstance(m11, numbers.Number) and isinstance(m22, str):
            ...
            return TypeError('All arguments need to be number.')
    ...
    def __add__(self, m):
        if isinstance(m, Matrix):
            ...
            return TypeError('add method needs be number or Matrix.')
    ...
    def __sub__(self, m):
        if isinstance(m, Matrix):
            ...
            return TypeError('sub method needs be number or Matrix.')
    ...
    def __mul__(self, m):
        if isinstance(m, Matrix):
            ...
            raise TypeError('mul method needs to be number or Matrix.')
    ...
    def __pow__(self, n):
        if isinstance(n, int):
            ...
            raise TypeError('pow method needs to be integer.')
